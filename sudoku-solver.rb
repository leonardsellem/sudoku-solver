...
module Sudoku
    ...
    # the puzzle and invokes the associated block once for each ruby cell whose
    # value is unknown.
    #
    ...
    class Puzzle
        ...
        # invoked on new Puzzle instances created with Puzzle.new. Pass the input # puzzle as an array of lines or as a single string. Use ASCII digits 1 # to 9 and use the '.' character for unknown cells. Whitespace,
        ...
        def initialize(lines)
            ...
            # The '!' in gsub! indicates that this is a mutator method that # alters the string directly rather than making a copy.
        ...
        # We override the array access operator to allow access to the # individual cells of a puzzle. Puzzles are two-dimensional, and must be indexed with row and column coordinates.
        def [](row, col)
        ...
        # This method defines a custom looping construct (an "iterator") for # Sudoku puzzles. For each cell whose value is unknown, this method
        # passes ("yields") the row number, column number, and box number to the this iterator.
        def each_unknown
...
# An exception of this class indicates that a puzzle is over-constrained # and that no solution is possible.
    ...
    def Sudoku.solve(puzzle)
        ...
        p.each do |guess| # For each value in the set of possible values
            ...
            begin
                ...
                # to the modified board, and will then guess another cell if needed. # Remember that solve() will either return a valid solution or
                # raise an exception.
